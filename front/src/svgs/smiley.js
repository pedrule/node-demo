...
export class SmileyAvatar extends SvgBase {
    static get svgTemplate() {
        return html`
        <svg id="smiley" width="733" xmlns="http://www.w3.org/2000/svg" height="733">
...
customElements.define('avatar-smiley', SmileyAvatar);